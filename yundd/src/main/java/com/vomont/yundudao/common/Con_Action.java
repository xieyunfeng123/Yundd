...
public interface Con_Action {
	public interface HTTP_PAMRS {
		...
		public static String problemid = "problemid";

		public static String problemtypeid = "problemtypeid";

		public static String relateddeviceid = "relateddeviceid";
		
		public static String relatedsubfactoryid="relatedsubfactoryid";

		public static String donetime = "donetime";

		public static String ownerid = "ownerid";
		public static String ccuserids = "ccuserids";
		
		public static String problemdesp="problemdesp";
		
		public static String imagecontents="imagecontents";
		...
		public static String actionresult="actionresult";
		
		public static String actiondesp="actiondesp";
		
		public static String searchdescription="searchdescription";
	...
	public interface HTTP_TYPE {
		...
		public static String type14 = "320";

		// 获取分类列表
		public static String type15 = "354";
		// 获取问题详情的列表
		public static String type16 = "360";

		// 获取问题详情
		public static String type17 = "361";
		// 上传问题详情
		public static String type18 = "357";
		
		// 问题处理
		public static String type19 = "362";
		
		// 录像列表
		public static String type20 = "384";
		
		// 录像详情
		public static String type21 = "385";
		
		public static String type22="389";
		
		public static String type23="389";
	}
