...
public class ImageSettingActivity extends Activity implements OnClickListener
{
    ...
    private void initData()
    {
        ...
        for (LocalMedia localMedia : sendList)
        {
        ...
        pager_img_setting.setOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                img_setting_index.setText(nowPosition + 1 + "");
                // LoadLocalImageUtil.getInstance().displayFromSDCard(sendList.get(arg0).getPath(), img_list.get(arg0));
//                Glide.with(getApplicationContext()).load(new File(sendList.get(arg0).getPath())).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(img_list.get(arg0));
               ImageLoader.getInstance().displayImage("file://"+sendList.get(position).getPath(), img_list.get(position));
            }
...
//        pager_img_setting.addOnPageChangeListener(new OnPageChangeListener()
//        {
//            @Override
...
//        });
    ...
    {
        super.onResume();
//        Glide.with(getApplicationContext()).load(new File(sendList.get(nowPosition).getPath())).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(img_list.get(nowPosition));
