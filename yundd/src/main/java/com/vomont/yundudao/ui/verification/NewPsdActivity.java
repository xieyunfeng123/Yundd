    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.go_back:
                ...
                break;
            case R.id.jump:
                shareUtil.setShare(num, null, userid, null, null,shareUtil.getShare().getAccountid(),null,0,null,0);
            ...
            case R.id.new_psd_finish:
                ...
                HttpUtil.post(reParams, new TextHttpResponseHandler()
                {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, String responseBody)
                    {
                        ...
                        {
                            shareUtil.setShare(num, new_psd_password.getText().toString(), userid, null, null,shareUtil.getShare().getAccountid(),null,0,null,0);
