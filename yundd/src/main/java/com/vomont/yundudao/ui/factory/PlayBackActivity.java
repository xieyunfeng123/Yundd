                ...
                switch (msg.what)
                {
                    case 100:
                        ...
                        else
                        {
                            ...
                            Toast.makeText(PlayBackActivity.this, "没有数据！", Toast.LENGTH_LONG).show();
                        }
                        dialog.dismiss();
                        break;
                    case 20:
                    ...
                    case 40:
                        isPlayIng = false;
                        Toast.makeText(PlayBackActivity.this, "打开失败！", Toast.LENGTH_LONG).show();
                        break;
                    case 50:
                        isPlayIng = false;
                        Toast.makeText(PlayBackActivity.this, "连接超时！", Toast.LENGTH_LONG).show();
                        break;
                    default:
                        break;
                }
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.play_back_zhua:
                ...
                if (name1 != null)
                {
                    Toast.makeText(PlayBackActivity.this, "抓拍成功！", Toast.LENGTH_LONG).show();
                }
                break;
