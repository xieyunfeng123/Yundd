...
public class DeleteVideoActivity extends Activity implements OnClickListener
{
                        ...
                        public void onClick(View v)
                        {
                            if (mlistPositions != null && mlistPositions.size() != 0)
                            {
                                for (int i = 0; i < mlistPositions.size(); i++)
                                {
                                    ...
                                    File file = new File(VideoManager.path + "/" + bean.getName() + ".mp4");
                                    if (file.exists())
                                    {
                                        file.delete();
                                        videoFragmentHelper.deleteName(DeleteVideoActivity.this, VideoManager.path + "/" + bean.getName() + ".mp4");
    ...
    public void showView()
    {
        ...
        if (mMlist != null && mMlist.size() != 0)
            ...
            {
                if (mMlist.get(i).getIsPack() == 0)
                {
                    unUpmlist.add(mMlist.get(i));
                }
                else if (mMlist.get(i).getIsPack() == 1)
                {
