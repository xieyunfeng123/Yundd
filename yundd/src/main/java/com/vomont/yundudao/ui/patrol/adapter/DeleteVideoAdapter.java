        ...
        switch (itemViewType)
        {
            ...
            case TYPE_ITEM:
                ...
                if (mlist.get(0).getMlist() != null || mlist.get(1).getMlist() != null)
                {
                    ...
                    asyncloadImage(holder.img, mlist.get(onePostion).getMlist().get(twoPostion).getVideoPath()+ "/" + mlist.get(onePostion).getMlist().get(twoPostion).getName() + ".mp4", onePostion, twoPostion);
