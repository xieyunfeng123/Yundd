package com.vomont.yundudao.ui.calendar;
...
public class KCalendar extends ViewFlipper implements android.view.GestureDetector.OnGestureListener
{
    ...
    public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#16A0E8"); // 星期标题文字颜色
    ...
    private void init()
    {
        ...
        firstCalendar.setBackgroundColor(Color.WHITE);
    ...
    private void drawFrame(LinearLayout oneCalendar)
    {
        ...
        tb = res.getDimension(R.dimen.layout_10dp);
