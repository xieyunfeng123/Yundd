...
import com.vomont.yundudao.utils.NetWorkUtils;
...
public class ApiRetrofit {
    ...
    private Interceptor mCacheInterceptor = chain -> {
        ...
        if (!NetWorkUtils.isNetworkAvailable(Appcation.getContext())) {
    ...
    public ApiRetrofit() {
        //cache url
        File httpCacheDirectory = new File(Appcation.getContext().getCacheDir(), "responses");
        ...
        mRetrofit = new Retrofit.Builder()
                .baseUrl(ApiService.TOP_HTTP+ ApiService.HTTP_IP)
